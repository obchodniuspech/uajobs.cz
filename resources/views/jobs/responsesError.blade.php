        ...
        <div class="container pt-50">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h1 class="section-title-large mb-30 wow animate__ animate__fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">Nastala chyba</h1>
                    <p class="mb-30 text-muted wow animate__ animate__fadeInUp animated">Asi špatný odkaz, nebo špatný pokus o vtip?</p>
                </div>
            </div>
